...
4. При написании автотестов для VCont ориентируйся на уже готовый проект автотестов VCont: `/home/ant/IdeaProjects/vcont-autotests`. Сначала изучи его структуру, фикстуры, helpers, стиль тестов и команды запуска, затем адаптируй существующие подходы под нужный VCont-сценарий.
   ...
   - Для последовательного прогона достаточно каталога вроде `tests/resources/fboot/` и fixture, которая копирует выбранный файл в `vcont1/.../vcont.fboot` и `vcont2/.../vcont.fboot` до `docker compose up`.
