...
description: Системно расследовать баги, тестовые падения, странное поведение и интеграционные сбои до попыток исправления. Использовать, когда нужно воспроизвести проблему, найти root cause, собрать evidence по слоям системы и только потом предлагать fix. Не использовать как замену самой реализации исправления после того, как причина уже доказана.
---
