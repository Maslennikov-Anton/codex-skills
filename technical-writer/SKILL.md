...
description: Создавать и улучшать техническую документацию для разработчиков, тестировщиков, операторов и пользователей. Использовать, когда Codex должен написать или переработать README, runbook, API guide, onboarding, release notes, эксплуатационную инструкцию или другую структурированную техническую документацию. Не использовать для продуктовой приоритизации — для этого есть `product-manager`, и не использовать как замену самой реализации или архитектурного решения — для этого есть профильные инженерные skills.
---
